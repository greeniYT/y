function CPreloader() {
    ...
    this._init = function () {
        ...
        s_oSpriteLibrary.addSprite("progress_bar", "./page/four_colors6/sprites/progress_bar.png");
        s_oSpriteLibrary.addSprite("200x200", "./page/four_colors6/sprites/200x200.jpg");
        s_oSpriteLibrary.addSprite("but_start", "./page/four_colors6/sprites/but_start.png");
