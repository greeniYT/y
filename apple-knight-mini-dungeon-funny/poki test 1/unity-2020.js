! function(n) {
    ...
    function d(n) {
        ...
        w.querySelectorAll(".image").forEach(function(n) {
            n.className === "".concat(k, " left") && (n.className = "".concat(k, " fromLeft")), n.className === "".concat(k, " right") && (n.className = "".concat(k, " fromRight")), -1 === n.className.indexOf("inactive") && (n.className += " inactive")
        }), w.querySelector('[data-idx="'.concat(L, '"]')).className = "".concat(k, " middle"), w.querySelector('[data-idx="'.concat(e, '"]')).className = "".concat(k, " left"), w.querySelector('[data-idx="'.concat(t, '"]')).className = "".concat(k, " right"), g.querySelectorAll(".bullet").forEach(function(n, e) {
            n.className = "bullet", e === L && (n.className += " active")
    ...
    k.setAttribute("id", "game"), s.appendChild(c), c.appendChild(l), c.appendChild(b), c.appendChild(x), l.appendChild(d), l.appendChild(f), f.appendChild(h), f.appendChild(m), f.appendChild(p), p.appendChild(g), p.appendChild(v), f.appendChild(y), g.appendChild(w), S.appendChild(k), document.body.appendChild(s), document.body.appendChild(S)
}, function(n, e, t) {
    var o = t(5);
    "string" == typeof o && (o = [
        [n.i, o, ""]
    ...
    function f(n, e, t, o) {
        var i = t ? "" : o.css;
        if (n.styleSheet) n.styleSheet.cssText = k(e, i);
        else {
        ...
        function c(n, e, o) {
            ...
            return function(r, a) {
                ...
                for (o.method = r, o.arg = a;;) {
                    ...
                    var d = t(n, e, o);
                    if ("normal" === d.type) {
                        if (i = o.done ? E : k, d.arg === I) continue;
                        return {
                            value: d.arg,
                            done: o.done
                        }
