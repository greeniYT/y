!function(t, i, e) {
    ...
    var T = function() {
        ...
        return l.getLocalDateString = function(t) {
            ...
            switch (i) {
              case "yynndd":
                return s.toString() + "å¹´" + n.toString() + "æœˆ" + h.toString() + "æ—¥";

              case "/":
                return s.toString() + "/" + n.toString() + "/" + h.toString();
            }
            return s.toString() + "å¹´" + n.toString() + "æœˆ" + h.toString() + "æ—¥" + o.toString() + "æ—¶" + r.toString() + "åˆ†" + a.toString() + "ç§’";
        }, h.getDay = function(t) {
        ...
        return s.setLoadUrl = function() {
            ...
            if (r.onLimixiu) {
                ...
                envVersion: "release",
                success: function() {
                    console.log("-------------è·³è½¬æˆåŠŸ--------------");
                },
                fail: function() {
                    console.log("-------------è·³è½¬å¤±è´¥--------------");
                },
                complete: function() {
                    console.log("-------------è·³è½¬æŽ¥å£è°ƒç”¨æˆåŠŸ--------------"), t.updateAdvsInfo();
                }.bind(this)
